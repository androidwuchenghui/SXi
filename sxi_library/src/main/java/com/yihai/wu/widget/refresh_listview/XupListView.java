package com.yihai.wu.widget.refresh_listview;
...
public class XupListView extends ListView implements OnScrollListener {
//    private static final String TAG = "XListView";
    ...
    public XupListView(Context context) {
        super(context);
        initWithContext(context);
    }

    public XupListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWithContext(context);
    }

    public XupListView(Context context, AttributeSet attrs, int defStyle) {
